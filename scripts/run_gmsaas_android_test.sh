...
# Usage:
#   scripts/run_gmsaas_android_test.sh [RECIPE_UUID] [TEST_CLASS] [GRADLE_TASK]
# Env:
#   GMSAAS_RECIPE_UUID, CONNECTBOT_ANDROID_TEST_CLASS, CONNECTBOT_GRADLE_TASK, GMSAAS_MAX_RUN_MINUTES, CONNECTBOT_TERMLIB_VERSION
# Notes:
...
INSTANCE_NAME="connectbot-androidtest-$(date +%Y%m%d-%H%M%S)"
